...
from homeassistant.components.media_player.const import (
    ...
    SUPPORT_VOLUME_STEP, SUPPORT_PLAY, SUPPORT_PAUSE, SUPPORT_STOP,
...
ATTRS_TEMPLATE_SCHEMA = vol.Schema({cv.slug: cv.template})
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend({
    ...
    vol.Optional(CONF_ATTRS_TEMPLATE, default={}):
        vol.Or(cv.ensure_list(ATTRS_TEMPLATE_SCHEMA), ATTRS_TEMPLATE_SCHEMA),
...
class UniversalMediaPlayer(MediaPlayerDevice):
    ...
    def __init__(self, hass, name, children,
                 commands, attributes, attrs_template,
                 state_template=None):
    ...
    def async_media_play(self):
        ...
        This method must be run in the event loop and returns a coroutine.
        """
        return self._async_call_service(SERVICE_MEDIA_PLAY, allow_override=True)
    ...
    def async_media_pause(self):
        ...
        This method must be run in the event loop and returns a coroutine.
        """
        return self._async_call_service(SERVICE_MEDIA_PAUSE, allow_override=True)
    ...
    def async_media_stop(self):
        ...
        This method must be run in the event loop and returns a coroutine.
        """
        return self._async_call_service(SERVICE_MEDIA_STOP, allow_override=True)
    ...
    def async_media_previous_track(self):
        ...
        This method must be run in the event loop and returns a coroutine.
        """
        return self._async_call_service(SERVICE_MEDIA_PREVIOUS_TRACK, allow_override=True)
    ...
    def async_media_next_track(self):
        ...
        This method must be run in the event loop and returns a coroutine.
        """
        return self._async_call_service(SERVICE_MEDIA_NEXT_TRACK, allow_override=True)
    ...
    def async_media_seek(self, position):
        ...
        return self._async_call_service(SERVICE_MEDIA_SEEK, data, allow_override=True)
    ...
    def async_play_media(self, media_type, media_id, **kwargs):
        ...
        return self._async_call_service(SERVICE_PLAY_MEDIA, data, allow_override=True)
    ...
    def async_media_play_pause(self):
        ...
        This method must be run in the event loop and returns a coroutine.
        """
        return self._async_call_service(SERVICE_MEDIA_PLAY_PAUSE, allow_override=True)
    ...
    def async_clear_playlist(self):
        ...
        This method must be run in the event loop and returns a coroutine.
        """
        return self._async_call_service(SERVICE_CLEAR_PLAYLIST, allow_override=True)
